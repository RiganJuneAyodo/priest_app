    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(width: 1.0, color: const Color(0xff464646)),
              ),
            ),
          ),
          Transform.translate(
          ...
          Transform.translate(
            offset: Offset(77.0, 176.0),
            child: SizedBox(
              width: 280.0,
              child: Text(
                'Clicca Per Creare Una Nuova Scaletta',
                style: TextStyle(
          ...
          Transform.translate(
            offset: Offset(23.09, 15.59),
            child:
                // Adobe XD layer: 'Create Account Butt…' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(106.91, 732.41),
                  child: Container(
                    width: 133.0,
                    height: 30.0,
                    decoration: BoxDecoration(
